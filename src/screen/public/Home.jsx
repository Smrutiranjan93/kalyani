      ...
      <Box>
        ...
        >
          ...
          >
            ...
            >
              Bivab Yashila where every sunrise is a melody, and every day is an
              ode to coastal living
            </Typography>
            <Button
              variant="contained"
              sx={{
                ...
                padding: { xs: '7px 0px',sm: '10px 0px', md: '21px 0px', lg: '21px 0px'},
                display: "flex",
                alignItems: "center",
                textAlign: "center",
                "&:hover": {
        ...
        >
          <Box sx={{ marginRight: "20px", display:'flex', flexDirection:'column' }}>
            <Typography
              variant="h6"
              fontWeight="700"
              sx={{
            ...
            >
              <Link target="_blank" href="https://pacms.orera.in/PromoterDetails/pdfviewNew/1302" sx={{alignItems: 'center',display: 'flex', textDecoration:'none', color: colors.yellow[100]}}>RERA &nbsp; <ArrowForwardIcon/></Link>
            </Typography>
            ...
            >
              ...
              the heart of Puri, Odisha. Boasting over 300 meticulously crafted
              apartments, BIVAB Yashila is set to redefine modern living in this
              serene coastal town.
            </Typography>
            <Typography
              variant="p"
            ...
            >
              ...
              Yashila is more than just a collection of homes; it’s a lifestyle
              curated for those who seek the perfect blend of tranquility and
              convenience.
            </Typography>
          </Box>
          <Box display='flex' flexDirection='column'>
            ...
            >
              Discover a harmonious living experience with thoughtfully designed
              spaces, modern amenities, and a scenic backdrop that echoes the
              spirit of Puri. Each apartment at BIVAB Yashila is a testament to
            ...
            >
              ...
              this coastal paradise, where the beauty of the surroundings meets
        ...
        >
          <Box sx={{ width: { xs: '100%', sm: '100%', md: '50vw', lg: '50vw'} }}>
            <Typography
              variant="h6"
              fontWeight="700"
              sx={{
            ...
            >
              ...
              workspace; it’s a gateway to a thriving business community, where
              the vibrancy of Puri converges with your entrepreneurial
              aspirations.
            </Typography>
          </Box>
        </Box>
        ...
        >
          ...
          <Box width="100%">
          <iframe loading="lazy" width="100%" height="400px" src="https://maps.google.com/maps?q=Bivab%20Yashila%2C%20Puri&amp;t=m&amp;z=10&amp;output=embed&amp;iwloc=near" title="Bivab Yashila, Puri" aria-label="Bivab Yashila, Puri"></iframe>
          </Box>
        </Box>

        {/* Contact Info Section */}
        <Box sx={{display:'flex', justifyContent:'space-around', marginTop:'50px', padding:{ xs: '0px 10px', sm: '0px 10px', md: '0px 100px', lg: '0px 100px'}, flexDirection:{ xs: 'column', sm: 'column', md: 'row', lg: 'row'}}}>
          <Box>
            <Typography
              variant="h6"
              fontWeight="700"
            ...
            <Box>
              ...
              >
                <ContactsIcon sx={{fontSize:'24px', marginRight:'15px'}}/>
                +91 7381262666
              </Typography>
              <Typography
                variant="p"
              ...
              >
                <AccessTimeFilledIcon sx={{fontSize:'24px', marginRight:'15px'}}/>
              ...
              >
                <MarkEmailReadIcon sx={{fontSize:'24px', marginRight:'15px'}}/>
                sales@bivabyashila.com
              </Typography>
            </Box>
          </Box>
          <Box sx={{display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center', textAlign:'center',marginLeft:{ xs: '0px', sm: '0px', md: '50px', lg: '50px'}}}>
            {/* Contact form */}
            <Snackbar
              open={openSnackbar}
